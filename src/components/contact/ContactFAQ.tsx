  ...
  return (
    <motion.div variants={itemVariants} className="relative">
      ...
      >
        ...
        <div
          className={`absolute -inset-px rounded-2xl bg-gradient-to-r from-[#e8a064] via-[#c9922a] to-[#d4915c] blur-sm transition-opacity duration-500 ${
            isOpen ? "opacity-70" : "opacity-0 group-hover:opacity-50"
          }`}
          aria-hidden={true}
        />
        <div
          className={`absolute -inset-px rounded-2xl bg-gradient-to-r from-[#e8a064]/60 via-[#c9922a]/60 to-[#d4915c]/60 transition-opacity duration-500 ${
        ...
        {/* Card body */}
        <div
          className={`relative overflow-hidden rounded-2xl border border-white/10 bg-[#141414]/[0.04] backdrop-blur-xl transition-shadow duration-500 ${
            isOpen ? "shadow-[0_0_50px_-12px_rgba(201,146,42,0.45)]" : ""
          }`}
        >
          <h3 className="m-0">
            <button
            ...
            >
              ...
              <span
                className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border transition-colors duration-300 ${
                  isOpen
                    ? "border-transparent bg-gradient-to-br from-[#e8a064] to-[#c9922a] text-white"
                    : "border-white/15 bg-[#141414]/5 text-slate-300 group-hover:border-white/30 group-hover:text-white"
                }`}
              >
...
export default function ContactFAQ() {
  ...
  return (
    <section
      id="faq"
      className="relative w-full overflow-hidden bg-[#0f0f0f] px-4 py-24 sm:px-6 sm:py-32 lg:px-8"
    >
      {/* Floating gradient blobs */}
      <motion.div
        aria-hidden={true}
        className="pointer-events-none absolute -left-40 -top-40 h-[480px] w-[480px] rounded-full bg-[#e8a064]/25 blur-[120px]"
        animate={{ x: [0, 40, 0], y: [0, 30, 0] }}
        transition={{ duration: 14, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        aria-hidden={true}
        className="pointer-events-none absolute -right-40 top-10 h-[420px] w-[420px] rounded-full bg-[#c9922a]/25 blur-[120px]"
        animate={{ x: [0, -30, 0], y: [0, 40, 0] }}
        transition={{ duration: 16, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        aria-hidden={true}
        className="pointer-events-none absolute bottom-[-160px] left-1/2 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-[#d4915c]/20 blur-[130px]"
      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        >
          <span className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#141414]/5 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-[#d4915c] backdrop-blur-md">
