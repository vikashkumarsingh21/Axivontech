...
export const metadata: Metadata = {
  title: "Executive & Founder Portal — Axivon Technologies",
  robots: {
    index: false,
    follow: false,
    nocache: true,
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#050505] text-gray-200">
      ...
      <div className="flex flex-col flex-1 overflow-hidden relative">
        {/* Top Navbar */}
        <header className="h-16 bg-[#0a0a0a] border-b border-amber-500/10 flex items-center justify-between px-6 sticky top-0 z-20 flex-shrink-0">
          <div className="flex items-center gap-3">
            <span className="text-xs font-semibold text-gray-400">Axivon Executive Governance</span>
            <span className="text-gray-600">/</span>
            <span className="text-xs font-bold text-amber-400 tracking-wide uppercase">{userRole}</span>
          </div>

          <div className="flex items-center gap-6">
            <Link href="/admin/notifications" className="relative text-gray-400 hover:text-white transition-colors">
              <Bell className="w-5 h-5" />
              <span className="absolute top-0 right-0 w-2 h-2 bg-amber-500 rounded-full border border-[#0a0a0a]"></span>
            </Link>
            ...
            <div className="flex items-center gap-3 pl-6 border-l border-white/10">
              ...
              <div className="hidden md:block text-xs">
                ...
                <p className="text-amber-400/80">{userRole}</p>
              </div>
            </div>
          </div>
        </header>
